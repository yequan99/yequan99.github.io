...
import expressLogo from './logos/expressjs.png';
...
export const tailwind = { names: "TailwindCSS" , img: tailwindLogo };
export const expressjs = { names: "ExpressJS", img: expressLogo };